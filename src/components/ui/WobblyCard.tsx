...
export const WobblyCard: React.FC<WobblyCardProps> = ({
  ...
  return (
    <div className={`relative ${className}`}>
      ...
      {/* Main card body: clean rounded solid border (rounded-xl), no box shadow */}
      <div
        onClick={isClickable ? onClick : undefined}
        className={`relative z-10 bg-[#F4F4F8] border-2 border-stone-900 rounded-xl transition-transform ${
