...
interface DrillLevelSelectProps {
...
export const DrillLevelSelect: React.FC<DrillLevelSelectProps> = ({
  selectedKanjiIds,
  onSelectLevel,
  onClearSelection,
  onStartDrill,
  ...
  return (
    <div className="flex-1 flex flex-col min-h-0 overflow-hidden px-5 pt-6 pb-2 max-w-sm mx-auto w-full">
      {/* Reusable LogoHeader with Drill Kanji Selection Title */}
      <LogoHeader>
        <h1 className="font-header font-extrabold text-2xl text-stone-900 tracking-tight">
          Drill Kanji Selection
        </h1>
      </LogoHeader>

      {/* Level Folder List: solid border outside, dashed inside, soft shadow */}
