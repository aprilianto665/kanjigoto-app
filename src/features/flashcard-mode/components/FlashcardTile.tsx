  ...
  return (
    ...
    >
      ...
      <div className="w-full h-full bg-white border-2 border-stone-900 rounded-3xl p-3 flex flex-col items-center justify-between shadow-[2px_4px_0px_0px_rgba(0,0,0,0.18)]">
        ...
        <div className="w-full h-full border-2 border-dashed border-stone-300 rounded-2xl flex flex-col items-center justify-between p-4 sm:p-5 relative overflow-hidden bg-white">
          {!isFlipped ? (
                ...
                <div className="space-y-0.5 w-full">
                  ...
                  <p
                    className={`font-kanji ${getFuriganaFontSizeClass(
                      furiganaText
                    )} font-bold text-stone-900 whitespace-nowrap select-none leading-tight`}
                  >
                    {furiganaText}
                  </p>
                </div>
